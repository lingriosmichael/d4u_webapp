  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-2 font-heading text-2xl font-semibold text-foreground">Seite nicht gefunden</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "D4U" },
      { property: "og:title", content: "D4U Finance — Belegverwaltung" },
      {
        property: "og:description",
        content: "Interne Belegverwaltung für D4U.",
      },
