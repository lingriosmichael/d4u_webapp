...
// session from cookies so RLS policies evaluate against the signed-in user
// (auth.uid()), not the anon role.
//
// TODO: parametrize as createServerClient<Database>(...) once
